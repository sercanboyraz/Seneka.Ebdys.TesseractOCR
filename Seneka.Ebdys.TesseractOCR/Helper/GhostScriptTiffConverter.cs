using log4net;
using Seneka.Ebdys.TesseractOCR.Helper.GhostscriptSharp;
using Seneka.Ebdys.TesseractOCR.Helper.GhostscriptSharp.Settings;
using System;
...
namespace Seneka.Ebdys.TesseractOCR.Helper
{
    ...
    #region GhostScriptTiffConverter
    ...
    public class GhostScriptTiffConverter
    {

    private static readonly ILog log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);
        public GhostScriptTiffConverter()
        {

        }
        public static string GhostScriptTiffConverterProcess(string dataPdf)
        {
            ...
            {
                log.Error("GhostScriptTiffConverterProcess" + Environment.NewLine + ex);
                return "";
            }
            return dataPdf.Replace(".pdf", ".tif");
        }
    }
}
